...
class ListenerMethod {
	 ...
	 * @param method
	 * @param parent
	 * @return <code>null</code> if the method is null or not a valid listener
	 *         method, the <code>ListenerMethod</code> otherwise
	 */
	@SuppressWarnings("unchecked") // Class<?> -> Class<? extends Event> -- Safe
	public static ListenerMethod of(Method method, @NonNull Listener parent) {
	 ...
	 *             if the event is not the right event
	 */
